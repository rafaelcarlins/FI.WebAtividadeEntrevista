...
namespace WebAtividadeEntrevista.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public void IncluirBeneficiario(List<Beneficiario> beneficiario, long IDCliente)
        {

            Beneficiario benef = new Beneficiario();
            BoBeneficiario boBenef = new BoBeneficiario();

            boBenef.Exclui(IDCliente);

            if (beneficiario[0] != null )
            {
                boBenef.Incluir(beneficiario);
            }
        ...
        [HttpPost]
        public JsonResult BenefList(long ID)
        {
            try
            {
                int qtd = 0;
        ...
        [HttpGet]
        public ActionResult Alterarbenef(string id)
        {
